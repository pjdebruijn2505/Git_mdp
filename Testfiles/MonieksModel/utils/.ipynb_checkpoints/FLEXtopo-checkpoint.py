import numpy       as np
from python_files.Weigfun import Weigfun
from python_files.plateau import plateau
from python_files.hillslope import hillslope
from python_files.wetland import wetland
...
def FLEXtopo(ParPlateau, ParHillslope, ParWetland, ParCatchment,forcing, landscapes):
	...
	for t in range(0,tmax):
		...
		Qtotdt[t]=Qsdt + (Fluxes_plateau[t, 3] + Fluxes_plateau[t, 2]) * landscapes[0] + (Fluxes_hillslope[t, 3] + Fluxes_hillslope[t, 2]) *landscapes[1] 
